...
execute if score RandomItemGiver MainNumber matches 12..1000 run execute as @a store result score @s ItemsReceivedTemp run loot give @s loot randomitemgiver:randomamountdifitems/normal_items
