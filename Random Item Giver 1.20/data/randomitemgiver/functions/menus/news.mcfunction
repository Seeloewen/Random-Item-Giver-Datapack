...
tellraw @s {"text":" "}
tellraw @s ["",{"text":"Version","color":"#F53377"},{"text":" 1.4.7","color":"#F53377"},{"text":" -","color":"gray"},{"text":" What's new?","color":"yellow"}]
...
tellraw @s ["",{"text":"(","color":"gray"},{"text":"-","color":"dark_red"},{"text":") ","color":"gray"},{"text":"Removed filled map as it was corrupted","color":"#FFFFB0"}]
tellraw @s {"text":" "}
