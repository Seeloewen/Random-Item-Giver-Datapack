...
tellraw @s {"text":" "}
tellraw @s {"text":"Special thanks to many awesome people who contributed to the datapack in some way! You can find them in the CREDITS.txt file in the root of this datapack's folder","color":"yellow"}
tellraw @s {"text":" "}
