...
tellraw @s {text: ' '}
tellraw @s [{text: '[',color: 'gray',click_event:{'action':'run_command', command: '/function randomitemgiver:dialogs/settings_home with storage randomitemgiver:settings general'},hover_event:{action: 'show_text', value: 'Show the datapack settings'}},{text: '➤',color: 'aqua',click_event:{'action':'run_command', command: '/function randomitemgiver:dialogs/settings_home with storage randomitemgiver:settings general'},hover_event:{action: 'show_text', value: 'Show the datapack settings'}},{text: ']',color: 'gray',click_event:{'action':'run_command', command: '/function randomitemgiver:dialogs/settings_home with storage randomitemgiver:settings general'},hover_event:{action: 'show_text', value: 'Show the datapack settings'}},{text: ' ',click_event:{'action':'run_command', command: '/function randomitemgiver:dialogs/settings_home with storage randomitemgiver:settings general'},hover_event:{action: 'show_text', value: 'Show the datapack settings'}},{text: 'Open the datapack settings',color: 'aqua',click_event:{'action':'run_command', command: '/function randomitemgiver:dialogs/settings_home with storage randomitemgiver:settings general'},hover_event:{action: 'show_text', value: 'Show the datapack settings'}}]
