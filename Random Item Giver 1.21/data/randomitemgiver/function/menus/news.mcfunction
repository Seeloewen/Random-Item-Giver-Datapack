...
tellraw @s {text: ' '}
tellraw @s [{text: 'Version',color: '#F53377'},{text: ' 1.5.7',color: '#F53377'},{text: ' -',color: 'gray'},{text: ' What`s new?',color: 'yellow'}]
...
tellraw @s [{text:"(",color:"gray"},{text:"⁎",color:"dark_aqua"},{text:") ",color:"gray"},{text:"Fixed incorrect pack format",color:"#FFFFB0"}]
