...
tellraw @s {text: ' '}
tellraw @s [{text: 'Version',color: '#F53377'},{text: ' 1.5.5',color: '#F53377'},{text: ' -',color: 'gray'},{text: ' What`s new?',color: 'yellow'}]
tellraw @s [{text: '(',color: 'gray'},{text: '+',color: 'dark_green'},{text: ') ',color: 'gray'},{text: 'Added all new items from 1.21.7',color: '#FFFFB0'}]
tellraw @s [{text: '(',color: 'gray'},{text: '⁎',color: 'dark_aqua'},{text: ') ',color: 'gray'},{text: 'Updated to 1.21.7 (Pack format 81)',color: '#FFFFB0'}]
tellraw @s {text: ' '}
