...
tellraw @s [{text: '(',color: 'gray'},{text: '+',color: 'dark_green'},{text: ') ',color: 'gray'},{text: 'Added all new items from 1.21.6',color: '#FFFFB0'}]
tellraw @s [{text: '(',color: 'gray'},{text: '⁎',color: 'dark_aqua'},{text: ') ',color: 'gray'},{text: 'Updated to 1.21.6 (Pack format 80)',color: '#FFFFB0'}]
tellraw @s {text: ' '}
