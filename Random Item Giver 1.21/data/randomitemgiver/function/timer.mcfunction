...
execute if data storage randomitemgiver:settings {general:{enabled:1}} if data storage randomitemgiver:settings {general:{enable_random_timer:0}} store result bossbar minecraft:rigtimer max run scoreboard players get rig internalMaxTimer
