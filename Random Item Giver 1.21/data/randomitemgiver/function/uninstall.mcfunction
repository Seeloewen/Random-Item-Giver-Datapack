...
tellraw @a [{text: '[',color: 'gray',click_event:{'action':'run_command', command: '/datapack enable \'file/random-item-giver-1-5-3-mc-1-21-5.zip\''},hover_event:{action: 'show_text', value: 'Enable the datapack again'}},{text: '➤',color: 'gold',click_event:{'action':'run_command', command: '/datapack enable \'file/random-item-giver-1-5-3-mc-1-21-5.zip\''},hover_event:{action: 'show_text', value: 'Enable the datapack again'}},{text: ']',color: 'gray',click_event:{'action':'run_command', command: '/datapack enable \'file/random-item-giver-1-5-3-mc-1-21-5.zip\''},hover_event:{action: 'show_text', value: 'Enable the datapack again'}},{text: ' ',click_event:{'action':'run_command', command: '/datapack enable \'file/random-item-giver-1-5-3-mc-1-21-5.zip\''},hover_event:{action: 'show_text', value: 'Enable the datapack again'}},{text: 'Click here to enable it again.',color: 'gold',click_event:{'action':'run_command', command: '/datapack enable \'file/random-item-giver-1-5-3-mc-1-21-5.zip\''},hover_event:{action: 'show_text', value: 'Enable the datapack again'}}]

#Disable Datapack
datapack disable "file/random-item-giver-1-5-3-mc-1-21-5.zip"
