...
execute if data storage randomitemgiver:settings {general:{show_useless_warnings:1}} run tellraw @s {text:"You received a debug stick, but it's unfortunately useless if you're not in creative mode.",color:"gold"}
...
advancement revoke @a only randomitemgiver:debug_stick_received