...
scoreboard objectives add randomItemsReceived dummy {"text":"Random Items Received", "color": "aqua"}
...
tellraw @a {text: ''}
tellraw @a {text: 'Random Item Giver 1.6.0 was successfully loaded!',color: 'green'}
