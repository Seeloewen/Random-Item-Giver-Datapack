...
tellraw @s {text: ' '}
tellraw @s [{text: 'Version',color: '#F53377'},{text: ' 1.6.1',color: '#F53377'},{text: ' -',color: 'gray'},{text: ' What`s new?',color: 'yellow'}]
tellraw @s [{text: '(',color: 'gray'},{text: '+',color: 'dark_green'},{text: ') ',color: 'gray'},{text: 'Added new items from 26.2',color: '#FFFFB0'}]
tellraw @s [{text:"(",color:"gray"},{text:"⁎",color:"dark_aqua"},{text:") ",color:"gray"},{text:"Updated datapack logo",color:"#FFFFB0"}]
tellraw @s [{text:"(",color:"gray"},{text:"⁎",color:"dark_aqua"},{text:") ",color:"gray"},{text:"Updated to 26.2",color:"#FFFFB0"}]
tellraw @s [{text:"(",color:"gray"},{text:"⁎",color:"dark_aqua"},{text:") ",color:"gray"},{text:"Fixed acacia boat appearing in smithing template loot table",color:"#FFFFB0"}]
