...
**A**: Every single one in the game as of 1.18.1.

**Q**: Does this work with the newest version of minecraft?
**A**: Yes, it does! It is confirmed to work with up to 1.18.1 and possibly higher. I always try to keep it up to date.
