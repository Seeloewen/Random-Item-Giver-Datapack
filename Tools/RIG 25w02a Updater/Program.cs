...
namespace Rigu2502
{
    public class Core
    {
        ...
        public static void Main()
        {
            ...
            //Entry
            Console.WriteLine("Welcome to the RIG 25w02a Updater by Seeloewen - Version 1.0.1 (07.04.2026).\n" +
        ...
        "Please select your datapack version:\n" +
        "1 - Version 25w02a\n" +
        "2 - Version 25w09a+");
            SelectVersion(int.Parse(Console.ReadLine()));
        ...
        private static void SelectVersion(int option)
        {
        ...
        private static void SelectMethod(int option)
        {
            switch (option)
            {
                case 1:
        ...
        private static string ConvertMessage(string message)
        {
            ...
            //If message contains the new line escape that is not supported between 25w02a and 25w09a, replace all escapes with empty space strings
            if (message.Contains("\\n") && version == 1)
            {
            ...
            //Also account for the need to convert unicode codes between 25w02a and 25w09a
            if (version == 1) message = ConvertUnicode(message);

            return message.Replace("[\"\",", "[")
                .Replace("\"", "\'");
        }

        private static void ConvertDatapack(string datapack)
        {
        ...
        private static string ConvertNewLines(string message)
        {
            int newLineAmount = 0;
        ...
        private static string ConvertUnicode(string message)
        {
            for (int i = 0; i < message.Length; i++)
            {
