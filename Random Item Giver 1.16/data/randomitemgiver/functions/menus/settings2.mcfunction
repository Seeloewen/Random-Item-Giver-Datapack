...
execute if score RandomItemGiver ShowItemAmount matches 1 run tellraw @s {"text":"[Enable]","color":"green","clickEvent":{"action":"run_command","value":"/function randomitemgiver:settings/enableitemamountscoreboard"},"hoverEvent":{"action":"show_text","contents":"Show amount of received items in scoreboard"}}
execute if score RandomItemGiver ShowItemAmount matches 2 run tellraw @s {"text":"[Disable]","color":"red","clickEvent":{"action":"run_command","value":"/function randomitemgiver:settings/disableitemamountscoreboard"},"hoverEvent":{"action":"show_text","contents":"Hide amount of received items in scoreboard"}}
tellraw @s {"text":" "}
